...
import { type DnsCacheLookup } from './utils/dns-cache.js';
...
*/
export type Method = 'GET' | 'POST' | 'PUT' | 'PATCH' | 'HEAD' | 'DELETE' | 'OPTIONS' | 'TRACE' | 'QUERY' | 'get' | 'post' | 'put' | 'patch' | 'head' | 'delete' | 'options' | 'trace' | 'query';
...
type OptionsToSkip = 'toJSON' | 'merge' | 'isHeaderExplicitlySet' | 'shouldCopyPipedHeader' | 'setPipedHeader' | 'getInternalHeaders' | 'setInternalHeader' | 'deleteInternalHeader' | 'trackStateMutations' | 'clearBody' | 'clearUnchangedCookieHeader' | 'restoreCookieHeader' | 'syncCookieHeaderAfterMerge' | 'stripUnchangedCrossOriginState' | 'stripSensitiveHeaders' | 'createNativeRequestOptions' | 'getRequestFunction' | 'freeze';
export type InternalsType = Except<Options, OptionsToSkip>;
export type OptionsError = NodeJS.ErrnoException & {
    options?: Options;
};
export type OptionsInit = OverrideProperties<Except<Partial<InternalsType>, 'hooks' | 'retry' | 'isStream'>, {
...
export default class Options {
    ...
    */
    ...
    createNativeRequestOptions(): Except<{
        h2session: ClientHttp2Session | undefined;
        _socketTimeout?: number | undefined;
        ...
        agent: false | http.Agent | {
            http2: false | import("./utils/http2-client.js").Http2Agent;
            http?: HttpAgent | false;
            https?: HttpsAgent | false;
        } | undefined;
        setHost: boolean;
